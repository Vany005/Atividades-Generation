...
public class Menu {
	...
	public static void main(String[] args) {
		...
		ContaCorrente cc1 = new ContaCorrente(contas.gerarNumero(), 123, 1, 1000f, "João da silva", 100.0f);
		contas.cadastrar(cc1);
		
		ContaCorrente cc2 = new ContaCorrente(contas.gerarNumero(), 124, 1, 2000f, "Maria da silva", 100.0f);
	...
	public static void sobre() {
		System.out.println("\n******************************");
		System.out.println("Projeto Desenvolvido por: Vania Beatriz");
		System.out.println("Linkedin-Vania Beatriz");
		System.out.println("github.com/Vany005");
		System.out.println("**********************************");
